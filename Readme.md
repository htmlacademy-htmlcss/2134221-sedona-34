...
* Студент: [Александер Ломоносов](https://up.htmlacademy.ru/htmlcss/34/user/2134221).
<<<<<<< HEAD
* Наставник: `АЛЕКСЕЙ ТОЛСТОНОГ!!!`.
=======
* Наставник: `Неизвестно`.
>>>>>>> parent of 8d413a6 (Добавляет наставника)
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2134221-sedona-34) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
